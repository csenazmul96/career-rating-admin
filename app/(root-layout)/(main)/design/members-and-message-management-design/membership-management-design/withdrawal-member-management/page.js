            ...
            <div className="member-list-form bg-secondaryBgColor border-t border-commonBorderColor py-6 px-12 ">
                ...
                <div className="flex items-center border-b border-commonBorderColor pb-3">
                            ...
                            <div className="right-col flex-1 py-4 pl-[20px]">
                                <RadioGroup className="flex  space-x-6">
                                    ...
                                    <RadioField>
                                        ...
                                        <Label className="font-normal">삭제</Label>
                                    </RadioField>
                                </RadioGroup>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col w-1/2">
                        <div className="flex items-stretch">
                            <div className="left-col  flex items-center w-[100px] bg-secondaryBgColor">
                                <span className="common-label-style"> </span>
                            </div>
                            <div className="right-col flex-1 py-4 pl-[20px] min-h-[58px]">

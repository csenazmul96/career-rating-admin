...
export const showSuccessToast = (title = '완료되었습니다.', subtitle = '변경하신 사항이') =>
    toast(
        <div className="flex items-center gap-4">
            <div className="!w-[36px] min-w-[36px] !h-[36px] bg-[#2962FF] rounded-full flex items-center justify-center">

                        ...
                        <ul className={`flex flex-col pr-6 gap-3 `}>
                            <li className={`p-4 flex items-center justify-between border hover:bg-secondaryLightColor border-borderColor`}>
                                ...
                                <div className="inner flex items-center gap-3 font-bold ">
                                    <span>10 점</span>
                                    <span><Equal className={`size-[20px]`} /></span>
                                </div>
                            </li>
                            <li className={`p-4 flex items-center justify-between border hover:bg-secondaryLightColor border-borderColor`}>
                                <div className="inner font-bold">
                                ...
                                <Table>
                                    <TableHead className="">
                                        <TableRow>
                                            ...
                                            <TableHeader className={`w-[60%]`}>답안 지문 작성</TableHeader>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell>
                                                <LmsStandardInputField singleElement={true} fieldClass='w-full'
                                                    placeholder={`A - 레이어 관리, B - 파일관리, C - 오토레이아웃`}/>
                                            </TableCell>
                                            <TableCell>
                                                <div className="flex gap-3">
                                                    <div className="relative">
                                                        <LmsStandardInputField placeholder={`이미지를 선택하세요.`}/>
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <div className="flex gap-4">
                                                    ...
                                                    <span
                                                        className={`flex items-center justify-center border text-[#000] border-commonBorderColor rounded-full size-[26px]`}>2</span>
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                                <LmsStandardInputField singleElement={true} fieldClass='w-full'
                                       ...
                                       <TableRow>
                                            <TableCell>
                                                <div className="flex gap-4">
                                                    <RadioGroup className="flex  space-x-6">
                                                        <RadioField>
                                                            <Radio color="lmsradio" value="permit" c />
                                                            <Label className="font-normal"></Label>
                                                        </RadioField>
                                                    </RadioGroup>
                                                    <span
                                                        className={`flex items-center justify-center border text-[#000] border-commonBorderColor rounded-full size-[26px]`}>3</span>
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                                <LmsStandardInputField singleElement={true} fieldClass='w-full'
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <div className="flex gap-4">
                                                    ...
                                                    <span
                                                        className={`flex items-center justify-center border text-[#000] border-commonBorderColor rounded-full size-[26px]`}>4</span>
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                                <LmsStandardInputField singleElement={true} fieldClass='w-full'
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <div className="flex gap-4">
                                                    ...
                                                    <span
                                                        className={`flex items-center justify-center border text-[#000] border-commonBorderColor rounded-full size-[26px]`}>5</span>
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                                <LmsStandardInputField singleElement={true} fieldClass='w-full'
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <div className="flex gap-4">
                                                    ...
                                                    <span
                                                        className={`flex items-center justify-center border text-[#000] border-commonBorderColor rounded-full size-[26px]`}>6</span>
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                                <LmsStandardInputField singleElement={true} fieldClass='w-full'

...
const AnnouncementFileUpload = ({ setForm, cleanForm, announcement = null}) => {
    ...
    const uploadFile = async (file) => {
        ...
        setForm((prev) => ({...prev, attachmentIds: [...prev.attachmentIds ,response.id]}));
    }
    ...
    useEffect(() => {
        if (announcement && announcement.announcementFiles.length) {
            setFileInfo(announcement.announcementFiles)
        }
    }, [announcement]);

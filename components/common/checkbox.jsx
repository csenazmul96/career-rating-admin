  ...
  return (
      <Headless.Field
          ...
          className={clsx(
              className,
              // Base layout
              'flex items-center gap-x-4 gap-y-1 ',
              // Control layout
...
const base = [
  // Basic layout
  'relative isolate flex size-[1.125rem] items-center justify-center rounded-[4px] sm:size-[26px]',
  // Background color + shadow applied to inset pseudo element, so shadow blends with border in light mode
  'before:absolute before:inset-0 before:-z-10 before:rounded-[2px] before:bg-white',
  ...
  // Border
  'border-2 border-borderColor group-data-[checked]:border-transparent group-data-[checked]:group-data-[hover]:border-transparent group-data-[hover]:border-borderColor group-data-[checked]:bg-[--checkbox-checked-border]',
  ...
  'after:absolute after:inset-0 after:rounded-[4px]',
...
const colors = {
  ...
  lmscheckbox: '[--checkbox-check:theme(colors.white)] [--checkbox-checked-bg:theme(colors.white)] [--checkbox-checked-border:theme(colors.borderColor)]',
}

export function Checkbox({ color = 'dark/zinc', className, clickHandler, onClickHandler= ()=>{}, ...props }) {
  ...
  return (
      ...
      <span className={clsx([base, colors[color]])}>
        {/*<svg*/}
        {/*    className="stroke-themeColor opacity-0 group-data-[checked]:opacity-100 size-[26px]"*/}
        {/*    viewBox="0 0 14 14"*/}
        {/*    fill="none"*/}
        {/*>*/}
        {/*  /!* Checkmark icon *!/*/}
        ...
        <svg width="22" height="22" className="stroke-themeColor opacity-0 group-data-[checked]:opacity-100 size-[22px]" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M18.3337 5.5L8.25033 15.5833L3.66699 11" className="opacity-100 group-data-[indeterminate]:opacity-0"  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>

...
const base = [
  // Basic layout
  'relative isolate flex size-[1.1875rem] shrink-0 rounded-full sm:size-[26px]',
  ...
  // Border
  'border-2 border-borderColor group-data-[checked]:border-transparent group-data-[checked]:group-data-[hover]:border-transparent group-data-[hover]:border-borderColor group-data-[checked]:bg-[--radio-checked-border]',
...
const colors = {
  ...
  lmsradio: '[--radio-checked-indicator:theme(colors.themeColor)] [--radio-checked-bg:theme(colors.white)] [--radio-checked-border:theme(colors.borderColor)]',
}

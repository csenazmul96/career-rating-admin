  ...
  return (
    <Headless.Dialog {...props}>
      ...
      <div className="fixed inset-0 w-screen overflow-y-auto pt-6 sm:pt-0">
        <div className="grid min-h-full grid-rows-[1fr_auto_1fr] justify-items-center sm:grid-rows-[1fr_auto_3fr] p-8">
          <Headless.DialogPanel
            transition
            className={clsx(
              className,
              sizes[size],
              'row-start-2 w-full  bg-white p-8 ring-1 ring-zinc-950/10  dark:bg-zinc-900 dark:ring-white/10 forced-colors:outline',
              'transition duration-100 data-[closed]:data-[enter]:scale-95 data-[closed]:opacity-0 data-[enter]:ease-out data-[leave]:ease-in shadow-[0_4px_4px_rgba(0,0,0,0.1)]'
            )}
          >
            {children}
          </Headless.DialogPanel>
